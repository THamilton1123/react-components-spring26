...
const MrooneyButton = () => {
    return (
        <Card>
            ...
            <br />
                <SplitButton title="Split Dropdown button" id="split-button">
                  <Dropdown.Item>Hover over the</Dropdown.Item>
                  <Dropdown.Item>2 parts of button</Dropdown.Item>
                </SplitButton>
            <br />
            <br />
                <SplitButton title="Split Dropup button" drop="up" id="split-button">
            ...
            <br />
            <br />
                <SplitButton title="Split Dropend button" drop="end" id="split-button">
                  <Dropdown.Item>this one is drop="end"</Dropdown.Item>
                  <Dropdown.Item>it goes right</Dropdown.Item>
                </SplitButton>
            <br />
            <br />
                <SplitButton title="Split Dropstart button" drop="start" id="split-button">
